...
class Account:
    ...
    def withdraw(self, amount):
        ...
        self.balance -= amount
        return f"withdrawal {amount} your new balance is {self.balance}."
    ...
    def request_loan(self, amount):
        ...
        return f"Loan amount {amount} granted, your New balance is {self.balance}, Loan outstanding: {self.loan}."
    def repay_loan(self, amount):
        ...
        return f"Repaid amount: {repay_amount} loan, Loan outstanding :{self.loan}, your current Balance is {self.balance}."
    ...
    def interest_calculation(self):
        ...
        return f"Interest rate {interest} New balance: {self.balance}."
    ...
    def close_account(self):
        ...
        self.frozen = False
        return "Account closed your balance set to zero and  transaction cleared."